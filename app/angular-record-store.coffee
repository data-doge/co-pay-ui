...
app.factory 'Records', (RecordStore, GroupRecordsInterface, UserRecordsInterface, MembershipRecordsInterface, PurchaseRecordsInterface, PaymentRecordsInterface) ->
  ...
  recordStore.addRecordsInterface(PurchaseRecordsInterface)
  recordStore.addRecordsInterface(PaymentRecordsInterface)
  recordStore